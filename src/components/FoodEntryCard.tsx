...
import FoodEntryDetailModal from './FoodEntryDetailModal'
  ...
  return (
    <>
      <motion.li
        ...
        className="flex cursor-pointer flex-col gap-2 rounded-xl bg-neutral-50 p-3 transition active:scale-[0.99] dark:bg-neutral-900"
      >
